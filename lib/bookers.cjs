...
function defaultBookers() {
  return [
    { id: "betano", name: "Betano", url: "https://www.betano.pt/", proxy: "", fp: randomFingerprint({ timezone: "Europe/Lisbon", locale: "pt-PT", languages: ["pt-PT", "pt", "en"] }) },
    { id: "pinnacle", name: "Pinnacle", url: "https://www.pinnacle.com/", proxy: "", fp: randomFingerprint({ timezone: "Europe/Nicosia", locale: "en-US" }) },
  ];
}
...
module.exports = { defaultBookers, randomFingerprint, buildFingerprintScript, UA_PRESETS, WEBGL_PRESETS };
