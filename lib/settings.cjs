...
const DEFAULTS = {
  ...
  valuePlaceMaxPerMarket: 1,  // макс. ставок на СОБЫТИЕ+МАРКЕТ (маркет=тип: ML/фора/тотал) — не две форы в одном матче; 0=без лимита
  valuePlaceMaxPerEvent: 0,   // макс. ставок на СОБЫТИЕ всего (доп-ставки в разных маркетах матча ок); 0 = без лимита
